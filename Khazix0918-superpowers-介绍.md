...
**原文链接：** https://x.com/Khazix0918/article/2037015170091016257

---

![文章封面](https://pbs.twimg.com/media/HETmH_ubsAAdJdJ?format=jpg&name=large)
...
![Superpowers Skills 概览](https://pbs.twimg.com/media/HETnnMobYAI5c28?format=jpg&name=medium)
...
![Skills 工作流程图](https://pbs.twimg.com/media/HEToBVTakAA2s85?format=jpg&name=4096x4096)
...
一种是**词性着色**，会把名词、动词、形容词用不同颜色标出来，句子结构会清楚很多。

![词性着色模式](https://pbs.twimg.com/media/HEToquYbYAU6gGG?format=jpg&name=medium)

还有一种模式是**段落聚焦**，正在阅读的这一段会被高亮，其他段落会压暗，适合读长段落，能明显减少周围文字带来的干扰，避免跑神。

![段落聚焦模式](https://pbs.twimg.com/media/HETo3RQbkAAlV09?format=jpg&name=900x900)
...
![14 个 Skills 列表](https://pbs.twimg.com/media/HETqaNDbYAAGYj-?format=jpg&name=medium)
...
Superpowers 本质上是一个由 14 个 Skills 组成的工作流系统，它强制 Agent 按照以下流程工作：

1. **brainstorming** - 头脑风暴，深入挖掘需求
2. **using-git-worktrees** - 创建隔离的工作区
3. **writing-plans** - 拆解成小任务清单
4. **subagent-driven-development** - 多 Agent 并行开发
5. **requesting-code-review** - 多轮代码审查
